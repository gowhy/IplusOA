   ...
   public class FTPHelper
    {
      ...
      //  string ftpURI;
        ...
        public FTPHelper(string FtpServerIP, string dirFtpRemotePath, string FtpUserID, string FtpPassword)
        {
            ftpServerIP = FtpServerIP;
            FtpRemotePath = dirFtpRemotePath;
            ftpUserID = FtpUserID;
        ...
        public void MakeDir(string dirName)
        {
            ...
            try
            {
                string[] dir = GetAllList(FtpURI + dirName);
